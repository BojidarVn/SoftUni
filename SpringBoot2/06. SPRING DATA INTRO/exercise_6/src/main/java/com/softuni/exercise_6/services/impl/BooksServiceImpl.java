...
import com.softuni.exercise_6.constants.GlobalConstants;
import com.softuni.exercise_6.entities.*;
import com.softuni.exercise_6.repositories.BookRepository;
...
public class BooksServiceImpl implements BookService {
    ...
    @Autowired
    public BooksServiceImpl(BookRepository bookRepository, AuthorService authorService
            , CategoryService categoryService, FileUtils fileUtils) {
    ...
    public void seedBooks() throws IOException {
        ...
        String[] fileContent = this.fileUtils.readFileContent(GlobalConstants.BOOKS_FILE_PATH);
    ...
    public List<Book> getAllBooksFromGeorgePowell() {
        ...
        return this.bookRepository.findBooksWithAuthor();
    }
