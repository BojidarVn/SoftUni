...
import springdataintroexercise.demo.repositories.CategoryRepository;
...
public class CategoryServiceImpl implements CategoryService {
    ...
    public void seedCategories() throws IOException {
        ...
        String[] fileContent = this.fileUtil.readFileContent(GlobalConstraints.CATEGORIES_FILE_PATH);
