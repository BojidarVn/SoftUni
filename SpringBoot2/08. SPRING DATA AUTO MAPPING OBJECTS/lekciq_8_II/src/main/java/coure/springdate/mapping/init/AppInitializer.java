package coure.springdate.mapping.init;

import coure.springdate.mapping.dto.EmployeeDto;
import coure.springdate.mapping.dto.ManagerDto;
...
public class AppInitializer implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        //  2. Create TypeMap mapping addresses and employees to ManagerDto with EmployeeDtos as subordinates
        ...
        // add manager and update employees
...
// Fetch all managers and map them to managerDto
        ...
        // 3. Employee born after 1990 with manager last name
