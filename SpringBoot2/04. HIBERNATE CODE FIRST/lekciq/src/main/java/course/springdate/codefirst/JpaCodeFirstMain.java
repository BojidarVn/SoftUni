package course.springdate.codefirst;

import course.springdate.codefirst.entity.*;
...
public class JpaCodeFirstMain {
    ...
    public static void main(String[] args) {
        ...
        car1.getDrivers().add((java.sql.Driver) driver1);
        truck1.getDrivers().add((java.sql.Driver) driver1);
        em.persist(driver1);
